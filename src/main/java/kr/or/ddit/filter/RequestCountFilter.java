...
public class RequestCountFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		// servlet/jsp로 요청을 보내기 전에 사전검사. (전처리)
		HttpServletRequest hsr = (HttpServletRequest)request; // 형변환 해주기.
...
//		Map<String, Integer> counterMap;
		...
		// 2-1. application 객체에 속성이 없을 경우 : 
		// 2-1-1. Map<String, Integer> counterMap 객체 생성
		// 2-1-2. 생성된 맵객체를 application 객체에 속성으로 등록
